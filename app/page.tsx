        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 transition rounded-xl font-medium shadow-md cursor-pointer"
            >
              Conectează-te
            </button>
            <button
              onClick={() => router.push("/signup")}
              className="px-6 py-3 border-2 border-blue-500 text-blue-400 hover:bg-gray-700 transition rounded-xl font-medium cursor-pointer shadow-md"
            >
              Creează cont
            </button>
          </div>
